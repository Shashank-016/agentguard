...
from .client import AgentMoatException, AgentMoatKilled
...
async def _raise_if_killed_async(guard: Any, source: str) -> None:
    """Async variant of :func:`agentmoat.client._raise_if_killed`.
    ...
    :class:`AsyncGuardedClient` and :class:`~agentmoat.openai_client.AsyncGuardedOpenAI`.
    """
...
async def _handle_engine_error_async(
    ...
    *,
    ...
    """Async variant of :func:`agentmoat.client._handle_engine_error`.
...
async def _evaluate_tool_use_async(
    ...
    """Async variant of :func:`agentmoat.client._evaluate_tool_use_sync`.
...
async def _dispatch_violation_async(
    ...
    *,
    ...
    """Async variant of :func:`agentmoat.client._dispatch_violation`.
